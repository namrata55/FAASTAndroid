...
public class UsageActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = createProgressDialog(UsageActivity.this);
        loadingDialog.show();
        Window window = UsageActivity.this.getWindow();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            window.setStatusBarColor(UsageActivity.this.getResources().getColor(R.color.my_statusbar_color));
        }
